...
- **constructor**
    ...
    - **Options**
      ...
      - `forceBase64` (`Boolean`): forces base 64 encoding for polling transport even when XHR2 responpe is available and WebSocket even if the used standard supports binary.
